...
from tools.visualize import plot_trees
...
def visualize_submission():
    ...
    # Targets to plot (Primes, Edges, Milestones)
    targets = [1, 2, 3, 5, 7, 10, 11, 12, 13, 17, 19, 23, 29, 50, 75, 100, 133, 152, 200]
    
    print(f"Generating plots for N={targets}...")
    ...
    for n in targets:
        ...
        plot_trees(group_df, output_path=output_dir / f"submission_{n:03d}.png")

if __name__ == "__main__":
    visualize_submission()
